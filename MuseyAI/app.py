...
GOOGLE_CLIENT_ID = '560500sdsdsdsdsddd420895-gp0nj2v6nlftuo2b4khk0o6i8dd62g0j.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET = 'GOsdsdsdCSPX--kqyxaI5HVT7Dtv_xoY76gOFee8a'
...
stripe_keys = {
    "secret_key": 'sk_test_SIhVjzsdsdmwZZteec3WCgsRxcG600hPDyrvJh',
    "publishable_key": 'pk_test_T4jeeCzO54vjsdsdFdEld3ighfil00tzeJwFSc',
    "price_id": 'price_1N1ksSC5i3ERpeBXsdsd7ILWjimN',
    "endpoint_secret": 'whsec_b4ae89e2fcccd20011sdsdsdb011a6f4073ad0c1b4d59c9c4367bc7744d42f6853a4ff',
}
...
async def auth(request: Request, db: Session = Depends(get_db)):
    ...
    redirect_url = 'http://localhost/test.php?accesstoken='+login_token
    return redirect_url
...
def create_checkout_session(request: Request):
    ...
    try:
        ...
        checkout_session = stripe.checkout.Session.create(
            ...
            success_url="http://localhost/test.php?session_id={CHECKOUT_SESSION_ID}",
            cancel_url="http://localhost/test.php?cancel=1",
            ...
            if len(imgobjs)>0:  
              ...
              for obj in imgobjs: 
                  if obj not in mergedobjects:
                      mergedobjects.append(obj.object_name)
                ...
                # for i mg_object in objects: 
                   #currdict[image_id].append(img_object)  
            responsedata["imageswithobjects"].append({"imageurl":image_url,"image_id": image_id,"imgobjects":imgobjects})
    ...
    try:
        ...
        if type(moodboard.moodboard_id) != int:
          ...
          if is_data_deleted == True: 
              crud.delete_moodboard(db,moodboard_id)
