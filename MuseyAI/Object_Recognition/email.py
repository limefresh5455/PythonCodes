...
conf = ConnectionConfig(
    MAIL_USERNAME="2deb337dasd831156",
    MAIL_PASSWORD="1e95eca11asda18238",
    MAIL_FROM="test@asdemail.com",
    MAIL_PORT=2525,
    MAIL_SERVER="sandbasdasox.smtp.mailtrap.io",
    MAIL_STARTTLS=True,
    MAIL_SSL_TLS=False,
                ...
                <html lang="en">
                    <body>
                        <div class="display:flex;align-items:center;justify-content:center;flex-direction:column">
                            ...
                            <h1" style="text-decoration:none;margin-top:1rem;font-size:1rem;background:red;color:#fff;padding:5px 10px"><a href='http://localhost/test.php?password={token}'>Reset Password</a></h1> 
                        </div>
                    </body>
                </html>
                """
